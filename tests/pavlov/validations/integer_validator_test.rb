...
require_relative '../../../lib/pavlov/validations/integer_validator'

describe ActiveModel::Validations::IntegerValidator do
  describe '#valid?' do
    let('test_class') do
  ...
  describe '.validate_integer' do
    ...
    let('test_class_with_allow_blank') do
      Class.new Pavlov::Entity do
        attributes :id
        validate_integer :id, allow_blank: true
      end
    end
